        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    break;
                case 2:
                    Mahasiswa01 dinilai = stack.pop01();
                    if (dinilai != null) {
                        System.out.println("Menilai tugas dari " + dinilai.nama);
                        System.out.print("Masukkan nilai (0-100): ");
                        int nilai = scan.nextInt();
                        dinilai.tugasDinilai01(nilai);
                    ...
                    break;
                case 3:
                    Mahasiswa01 lihat = stack.peek01();
                    if (lihat != null) {
                        System.out.println("Tugas terakhir dikumpulkan oleh " + lihat.nama);
                    }
                    break;
                case 4:
                    Mahasiswa01 lihatBottom = stack.peekBottom01();
                    if (lihatBottom != null) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Total tugas yang dikumpulkan: " + stack.hitungTotalTugas01());
                    break;
                default:
